...
class ZnpAdapterManager {
    constructor(znp, options, logger) {
        this.debug = {
            startup: debug_1.default("zigbee-herdsman:adapter:zStack:startup"),
            strategy: debug_1.default("zigbee-herdsman:adapter:zStack:startup:strategy"),
            commissioning: debug_1.default("zigbee-herdsman:adapter:zStack:startup:commissioning")
        };
        this.znp = znp;
